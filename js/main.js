...
$("#inst_main_body").html("<div id = 'instructions_head'>CÓMO JUGAR</div><p>El objetivo de Hextris es evitar que los bloques salgan del interior del hexágono gris exterior.</p><p>" + (settings.platform != 'mobile' ? 'Presiona las teclas de flecha izquierda y derecha' : 'Toca los lados izquierdo y derecho de la pantalla') + " para girar el hexágono." + (settings.platform != 'mobile' ? ' Presiona la flecha hacia abajo para acelerar la caída del bloque' : '') + " </p><p>Elimina bloques y gana puntos haciendo que 3 o más bloques del mismo color se toquen.</p><p>El tiempo restante antes de que tu racha de combos desaparezca está indicado por <span style='color:#f1c40f;'>las</span> <span style='color:#e74c3c'>líneas</span> <span style='color:#3498db'>de colores</span> <span style='color:#2ecc71'>en</span> el hexágono exterior</p> <hr> <p id = 'afterhr'></p> Por Tiziano Guevara, Gabriel Grosso, Maximiliano Rodríguez y Bruno García.");
	if (gameState == 1) {
		pause();
	}
